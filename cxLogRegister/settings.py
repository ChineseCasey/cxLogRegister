"""
Django settings for cxLogRegister project.
...
SECRET_KEY = 'qnwi$cu(gtg&^9d3zw6+_5p=tn4qwnjigriuan=pi1*+5rpt#k'
...
ROOT_URLCONF = 'cxLogRegister.urls'
...
WSGI_APPLICATION = 'cxLogRegister.wsgi.application'
